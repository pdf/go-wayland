...
func main() {
	...
	fmt.Fprintf(w, "// https://github.com/pdf/go-wayland/cmd/go-wayland-scanner\n")
	...
	if protocol.Name != "wayland" {
		fmt.Fprintf(w, "import \"github.com/pdf/go-wayland/client\"\n")
		fmt.Fprintf(w, "import xdg_shell \"github.com/pdf/go-wayland/stable/xdg-shell\"\n")
	}
